#!/bin/sh
#SBATCH --job-name=spipe12E   ## Name of the job
#SBATCH -A seyedam_lab            ## account to charge 
#SBATCH -p standard               ## partition/queue name
#SBATCH --nodes=1                 ## (-N) number of nodes to use
#SBATCH --cpus-per-task=16         ## number of cores the job needs
#SBATCH --output=spipe12E-%J.out ## output log file
#SBATCH --error=spipe12E-%J.err ## error log file
#SBATCH --mem=128G
...
split-pipe \
	...
	--fq1 "${datapath}/fastq/Ctx_12kE_R1.fastq.gz" \
	--fq2 "${datapath}/fastq/Ctx_12kE_R2.fastq.gz" \
	--output_dir "${datapath}/analysis_12E/" \
