...
gunzip ../../fastq/5X_12kA_R*.fastq.gz
...
python demux_fastqs.py \
 ...
 -f1 ../../fastq/5X_12kA_R1.fastq \
 -f2 ../../fastq/5X_12kA_R2.fastq \
 -t 32

gzip ../../fastq/5X_12kA_R*.fastq
gzip ../../analysis_12A/process/single_cells_barcoded_head.fastq

############

gunzip ../../fastq/5X_12kB_R*.fastq.gz
...
python demux_fastqs.py \
 ...
 -f1 ../../fastq/5X_12kB_R1.fastq \
 -f2 ../../fastq/5X_12kB_R2.fastq \
 -t 32

gzip ../../fastq/5X_12kB_R*.fastq
gzip ../../analysis_12B/process/single_cells_barcoded_head.fastq

############

gunzip ../../fastq/5X_12kC_R*.fastq.gz
...
python demux_fastqs.py \
 ...
 -f1 ../../fastq/5X_12kC_R1.fastq \
 -f2 ../../fastq/5X_12kC_R2.fastq \
 -t 32

gzip ../../fastq/5X_12kC_R*.fastq
gzip ../../analysis_12C/process/single_cells_barcoded_head.fastq

############

gunzip ../../fastq/5X_12kD_R*.fastq.gz
...
python demux_fastqs.py \
 ...
 -f1 ../../fastq/5X_12kD_R1.fastq \
 -f2 ../../fastq/5X_12kD_R2.fastq \
 -t 32

gzip ../../fastq/5X_12kD_R*.fastq
gzip ../../analysis_12D/process/single_cells_barcoded_head.fastq

############

gunzip ../../fastq/5X_12kE_R*.fastq.gz
...
python demux_fastqs.py \
 ...
 -f1 ../../fastq/5X_12kE_R1.fastq \
 -f2 ../../fastq/5X_12kE_R2.fastq \
 -t 32

gzip ../../fastq/5X_12kE_R*.fastq
gzip ../../analysis_12E/process/single_cells_barcoded_head.fastq

############

gunzip ../../fastq/5X_12kF_R*.fastq.gz
...
python demux_fastqs.py \
 ...
 -f1 ../../fastq/5X_12kF_R1.fastq \
 -f2 ../../fastq/5X_12kF_R2.fastq \
 -t 32

gzip ../../fastq/5X_12kF_R*.fastq
gzip ../../analysis_12F/process/single_cells_barcoded_head.fastq

############

gunzip ../../fastq/5X_2kA_R*.fastq.gz
...
python demux_fastqs.py \
 ...
 -f1 ../../fastq/5X_2kA_R1.fastq \
 -f2 ../../fastq/5X_2kA_R2.fastq \
 -t 32

gzip ../../fastq/5X_2kA_R*.fastq
