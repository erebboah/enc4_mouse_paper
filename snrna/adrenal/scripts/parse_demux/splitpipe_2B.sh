#!/bin/sh
#SBATCH --job-name=spipe2B   ## Name of the job
#SBATCH -A seyedam_lab            ## account to charge 
#SBATCH -p standard               ## partition/queue name
#SBATCH --nodes=1                 ## (-N) number of nodes to use
#SBATCH --cpus-per-task=16         ## number of cores the job needs
#SBATCH --output=spipe2B-%J.out ## output log file
#SBATCH --error=spipe2B-%J.err ## error log file
#SBATCH --mem=128G
...
split-pipe \
	...
	--fq1 ../../fastq/Adr_2kB_R1.fastq.gz \
	--fq2 ../../fastq/Adr_2kB_R2.fastq.gz \
	--output_dir ../../analysis_2B/ \
	--sample A_4_F1 A1-A1 \
	--sample A_4_F2 B1-B1 \
	--sample A_4_M1 C1-C1 \
	--sample A_4_M2 D1-D1 \
